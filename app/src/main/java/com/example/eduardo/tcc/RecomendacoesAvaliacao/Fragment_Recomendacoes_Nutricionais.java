 ...
 */
public class Fragment_Recomendacoes_Nutricionais extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        contentView = inflater.inflate(R.layout.recomendacoes_nutricionais, null);
